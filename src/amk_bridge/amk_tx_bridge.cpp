...
AmkFrontLeftSetpoints1 front_left_amk_setpoints = {
  amkFrontLeftControl_t{0, 0, 0, 0, 0, 0}, 0, 0, 0};
AmkFrontRightSetpoints1 front_right_amk_setpoints = {
  amkFrontRightControl_t{0, 0, 0, 0, 0, 0}, 0, 0, 0};
...
AmkRearRightSetpoints1 rear_right_amk_setpoints = {
  amkRearRightControl_t{0, 0, 0, 0, 0, 0}, 0, 0, 0};
...
private:
  void amk_control_callback(const putm_pm09_vcl::msg::AmkControl msg) const
  {
    front_left_amk_setpoints.AMK_Control = {
      0,
      msg.amk_control_binverter_on[0],
      msg.amk_control_bdc_on[0],
      msg.amk_control_benable[0],
      msg.amk_control_amkb_error_reset[0],
      0};
    ...
    front_right_amk_setpoints.AMK_Control = {
      0,
      msg.amk_control_binverter_on[1],
      msg.amk_control_bdc_on[1],
      msg.amk_control_benable[1],
      msg.amk_control_amkb_error_reset[1],
      0};
    ...
    rear_left_amk_setpoints.AMK_Control = {
      0,
      msg.amk_control_binverter_on[2],
      msg.amk_control_bdc_on[2],
      msg.amk_control_benable[2],
      msg.amk_control_amkb_error_reset[2],
      0};
    ...
    rear_right_amk_setpoints.AMK_Control = {
      0,
      msg.amk_control_binverter_on[3],
      msg.amk_control_bdc_on[3],
      msg.amk_control_benable[3],
      msg.amk_control_amkb_error_reset[3],
      0};
