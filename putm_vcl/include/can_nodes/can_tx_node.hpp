...
//_________
  ...
  const uint8_t amk_data_limiter = 80; // amk_data_limiter is a const value that limits how often inverters info is sent on CAN frame. A value "90" means 10ms * 90 = 900ms.
