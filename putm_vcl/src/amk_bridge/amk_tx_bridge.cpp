...
void AmkTxNode::amk_control_callback(const putm_vcl_interfaces::msg::AmkControl msg) const {
  ...
  front_left_amk_setpoints.AMK_TargetVelocity = msg.amk_target_torque[0];
  front_left_amk_setpoints.AMK_TorqueLimitPositiv = msg.amk_torque_positive_limit[0];
  front_left_amk_setpoints.AMK_TorqueLimitNegativ = msg.amk_torque_negative_limit[0];
  ...
  front_right_amk_setpoints.AMK_TargetVelocity = msg.amk_target_torque[1];
  front_right_amk_setpoints.AMK_TorqueLimitPositiv = msg.amk_torque_positive_limit[1];
  front_right_amk_setpoints.AMK_TorqueLimitNegativ = msg.amk_torque_negative_limit[1];
  ...
  rear_left_amk_setpoints.AMK_TargetVelocity = msg.amk_target_torque[2];
  rear_left_amk_setpoints.AMK_TorqueLimitPositiv = msg.amk_torque_positive_limit[2];
  rear_left_amk_setpoints.AMK_TorqueLimitNegativ = msg.amk_torque_negative_limit[2];
  ...
  rear_right_amk_setpoints.AMK_TargetVelocity = msg.amk_target_torque[3];
  rear_right_amk_setpoints.AMK_TorqueLimitPositiv = msg.amk_torque_positive_limit[3];
  rear_right_amk_setpoints.AMK_TorqueLimitNegativ = msg.amk_torque_negative_limit[3];
}
